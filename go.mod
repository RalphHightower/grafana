...
require (
	...
	github.com/chromedp/cdproto v0.0.0-20260804232424-e85f50dbfd32 // @grafana/data-sources
	github.com/dgraph-io/badger/v4 v4.9.6 // @grafana/grafana-search-and-storage
	...
	github.com/getkin/kin-openapi v0.146.0 // @grafana/grafana-app-platform-squad
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.45.0 // @grafana/grafana-backend-group
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.45.0 // @grafana/grafana-backend-group
