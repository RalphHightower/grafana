...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/s3 v1.100.1 // @grafana/grafana-search-and-storage
	...
	github.com/grafana/grafana-app-sdk v0.54.0 // @grafana/grafana-app-platform-squad
